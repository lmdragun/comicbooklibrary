...
Using this code:
Fork this github and clone into your computer. Run the following code in order: bundle install, rake db:create db:migrate, then rails s, and go to localhost:3000 on your browser.
